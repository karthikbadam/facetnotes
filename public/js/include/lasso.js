d3.lasso = function () {
    ...
    function lasso() {
        ...
        function dragstart() {
            ...
            items.each(function (d) {
                ...
                var box = d3.select(this)["_groups"][0][0].getBoundingClientRect();
                d.lassoPoint = {
            ...
            if (hoverSelect === true) {
                items.on("mouseover.lasso", function (d) {
                    // if hovered, change lasso selection attribute to true
                    d.hoverSelected = true;
                });
            }
    ...
    lasso.svgParent = function (_) {
        if (!arguments.length) return svgParent;
        svgParent = _;
        return lasso;
    };
