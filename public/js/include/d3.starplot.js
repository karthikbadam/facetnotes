...
d3.starPlot = function () {
    ...
    function drawChart() {
        ...
        var path = d3.radialLine()
            .angle(function (d, i) {
                return Math.PI / 2 + radians * i;
            })
            .radius(function (d, i) {
                var userScale = scales[i] || scales[0];
                return scale(userScale(datum[d]["variance"]));
            });
        ...
        properties.forEach(function (d, i) {
            ...
            pathData.push([
                scale(userScale(datum[d]["variance"])),
                r
            ])
            r += radians;
        });
    ...
    function drawInteraction() {
        ...
        properties.forEach(function (d, i) {
            ...
            var userScale = scales[i] || scales[0];
            lValue = scale(userScale(datum[d]["variance"]));
